...
# data set
dataset=../fs-moses-bio-experiments/data/alzheimers.moses

# directory name of the experiment
exp_dir=alzheimers_combine_test

# K-fold cross validation (if 1, no cross-validation). It also changes
# the random seed.
Kfd=2
...
# fsm_conf_seq=(1.0 1.5 2.0)            # for hc
fsm_conf_seq=(1.0 2.0)            # for hc
